  ...
  return (
    <div className={styles.appWrapper}>
      ...
      <div className={styles.guideContent}>
        ...
        />
        <p>
          The easiest way to understand a potentiometer is by looking at a
          diagram with it's pinouts.
        </p>
        <GuideImage
        ...
        <p>
          ...
          10k&#8486; potentiometer, we mean that the max resistance (between 1
          and 3) is that value. As we rotate the knob counterclockwise (with the
        ...
        <p>
          ...
          measure contact 2 (A0 on the Arduino). It doesn't matter if contact 1
          is connected to 5V or Ground, as long as 3 is the other.
        </p>
        <GuideImage
